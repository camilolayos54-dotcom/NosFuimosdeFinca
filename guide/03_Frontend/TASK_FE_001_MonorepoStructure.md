...
- [ ] TASK_FE_001 — Inicialización del Monorepo Frontend y Estructura de Directorios 📅 2026-08-05 08:00
	- [ ] Paso 1: Navegar al directorio raíz del proyecto frontend
		- [ ] Acceder a la carpeta frontend/ en la raíz del repositorio de NosFuimosdeFinca
	- [ ] Paso 2: Crear la estructura física de carpetas
		- [ ] Crear src/pages/, src/components/, src/services/, src/styles/, src/utils/, src/store/ y public/assets/
	- [ ] Paso 3: Inicializar el archivo package.json
		- [ ] Ejecutar npm init -y
		- [ ] Instalar Vite 5.x como dependencia de desarrollo
		- [ ] Configurar scripts dev, build y preview
