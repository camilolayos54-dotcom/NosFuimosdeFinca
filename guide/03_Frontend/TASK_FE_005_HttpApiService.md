...
- [ ] TASK_FE_005 — Servicio HTTP Fetch API y Manejo de Errores REST 📅 2026-08-05 10:00
	- [ ] Paso 1: Crear el archivo src/services/api.js
		- [ ] Implementar la función asíncrona apiRequest(endpoint, options)
		- [ ] Inyectar la cabecera Authorization: Bearer <"jwt> si existe token en localStorage
		- [ ] Procesar respuestas HTTP de error (400, 401, 403, 500) y lanzar excepciones descriptivas
	- [ ] Paso 2: Exponer envoltorios HTTP helpers
		- [ ] Exportar métodos apiGet, apiPost, apiPut, apiDelete
