- [x] TASK_FE_002 — Configuración Bundler Vite MPA y Servidor de Desarrollo 📅 2026-08-05 08:30
	- [x] Paso 1: Crear el archivo vite.config.js en la raíz de frontend/
		- [x] Importar la función resolve del módulo 'path' de Node.js
	- [x] Paso 2: Configurar la opción build.rollupOptions.input para Multi-Page Application
		- [x] Registrar los 15 puntos de entrada HTML (home, catalog, property-detail, checkout, auth, dashboard, etc.)
	- [x] Paso 3: Configurar el proxy de desarrollo local en server.proxy
		- [x] Mapear el prefijo '/api' redirigiendo hacia http://localhost:8080 con changeOrigin activado
